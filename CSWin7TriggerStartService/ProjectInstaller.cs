    ...
    public partial class ProjectInstaller : Installer
    {
        ...
        private void triggerStartServiceInstaller_AfterInstall(object sender, InstallEventArgs e)
        {
            ...
            if (Environment.OSVersion.Version >= new Version(6, 1))
            {
                ...
                SetServiceTriggerStartOnCustomEvent(triggerStartServiceInstaller.ServiceName);
        ...
        private static readonly Guid CUSTOM_EVENT_GUID =
            new Guid("B52C6D34-59C9-4DFC-80CB-3B6502F5D5CC");
